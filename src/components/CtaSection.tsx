...
export default function CtaSection({
  ...
  body = 'The free in-home water test takes about 30 minutes. We test hardness, iron, chlorine, TDS, and pH at your tap, show you the results on the spot, and give you a straight answer, even if that answer is that your water is fine.',
}: CtaSectionProps) {
  return (
